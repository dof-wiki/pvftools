...
const (
	PathHellDrop         = "etc/itemdropinfo_monster_hell.etc"
	PathMonsterDrop      = "etc/itemdropinfo_monseter.etc"
	...
	PathBreathGreen  = "stackable/consumption_1256.stk"
	PathBreathYellow = "stackable/consumption_1257.stk"
)
